    ...
    return (
      <div style={{ textAlign: "center", padding: "40px 0px" }}>
        <h3 style={{ fontSize: "19px", fontWeight: 700, color: theme.color }}>
          Вы еще не добавили ни одного поста в свои закладки
        </h3>
        <p>Когда вы это сделаете, они появятся здесь</p>
      </div>
    );
          ...
          <React.Fragment>
            ...
            >
              <PeopleFlex hover border={theme.border} tweetHov={theme.tweetHov}>
                <User>
                  <UserImage style={{objectFit: "cover"}} src={tweet.avatar} />
                </User>
                <div style={{ width: "80%" }}>
